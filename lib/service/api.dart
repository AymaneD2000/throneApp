...
class Api extends ChangeNotifier {
  ...
  Future<void> userRegistration(User user, BuildContext context) async {
  ...
  Future<void> getLoggedInformation() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
            'Failed to fetch user information: ${errorData['message']}');
      }
    } catch (e) {
  ...
  Future<void> fetchMusicsData() async {
    final Uri url = Uri.parse(
        '${_baseEndpoint}products'); // Replace with your actual API endpoint.
